...
docker build --provenance=false --platform linux/amd64 -t algonotes-interview-prep-backend -f Dockerfile.prod .

echo Tagging image as 'latest'...
docker tag algonotes-backend-prod:latest 692299587899.dkr.ecr.ap-south-1.amazonaws.com/algonotes-interview-prep-backend:latest
