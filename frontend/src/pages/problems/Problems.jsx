...
const Problems = () => {
  ...
  const handleDeleteProblem = async (id, e) => {
    ...
    if (
      !window.confirm(
        "Are you sure you want to permanently delete this logged solution and its notes?",
      )
    ) {
      return;
    }
  ...
  const filteredProblems = problems.filter((problem) => {
    ...
    return (
      matchesSearch && matchesPlatform && matchesDifficulty && matchesLanguage
    );
  });
                  ...
                  >
                    ...
                    >
                      <div className="flex items-center justify-end gap-1.5">
                        ...
                        <Link
                          to={`/problems/${problem.id}/note/generate`}
                          state={{ problem }}
